...
import com.itfsw.mybatis.generator.plugins.ExampleEnhancedPlugin;
...
public class MybatisGeneratorBridge {
    ...
    public void generate() throws Exception {
        ...
        exampleTargetPlugin.addProperty("type", ExampleTargetPlugin.class.getName());
        exampleTargetPlugin.addProperty(ExampleTargetPlugin.PRO_TARGET_PACKAGE, generatorConfig.getModelPackage() + ".example");
        exampleTargetPlugin.setConfigurationType(ExampleTargetPlugin.class.getName());
        context.addPluginConfiguration(exampleTargetPlugin);
        /**
         * example增强插件
         */
        PluginConfiguration exampleEnhancePlugin = new PluginConfiguration();
        exampleEnhancePlugin.addProperty("type", ExampleEnhancedPlugin.class.getName());
        exampleEnhancePlugin.setConfigurationType(ExampleEnhancedPlugin.class.getName());
        context.addPluginConfiguration(exampleEnhancePlugin);
